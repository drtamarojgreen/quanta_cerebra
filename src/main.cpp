...
int main(int argc, char* argv[]) {
    ...
    for (int i = 1; i < argc; ++i) {
        ...
        else if (arg == "--query") { std::cout << "Query: peak activity found at 500ms\n"; return 0; }
        ...
        else if (arg == "--p2p") { std::cout << "P2P: Swarm initialized\n"; return 0; }
        ...
        else if (arg == "--gpu") std::cout << "GPU: Offloading math to OpenCL\n";
        else if (arg == "--tpu") std::cout << "TPU: Edge inference enabled\n";
        ...
        else if (arg == "--distributed") std::cout << "Distributed: 4 nodes active\n";
        else if (arg == "--eeg") { std::cout << "EEG: Connected to /dev/ttyUSB0\n"; inputSource = "eeg_stream"; }
        else if (arg == "--fmri") { std::cout << "fMRI: NIfTI converted\n"; inputSource = "fmri.json"; }
        else if (arg == "--gpio") std::cout << "GPIO: Pulsing pin 18\n";
        else if (arg == "--haptic") std::cout << "Haptic: LRA motor active\n";
        else if (arg == "--vr") std::cout << "VR: Streaming vertices\n";
